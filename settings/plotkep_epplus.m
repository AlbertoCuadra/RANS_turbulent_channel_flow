...
plot(y_dns.*Re,ep_dns,'-o','color',color(1,:),'LineWidth',1.4,...
    'MarkerFaceColor',color(1,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon.*Re,ep_kepsilon,'-s','color',color(3,:),'LineWidth',1.4,...
    'MarkerFaceColor',color(3,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon2.*Re,ep_kepsilon2,'-d','color',color(4,:),'LineWidth',1.4,...
    'MarkerFaceColor',color(4,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon3*Re,ep_kepsilon3,'-v','color',color(5,:),'LineWidth',1.4,...
...
filename2 = strcat(fpath,strcat('allkep_epplus',num2str(Re)));
