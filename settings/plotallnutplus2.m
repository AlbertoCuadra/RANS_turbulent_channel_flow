...
plot(d(1).d(1:end-1,1).*Re,nut_dns,'-','color',color(1,:),'LineWidth',2,...
    'MarkerFaceColor',color(1,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_mixing.*Re,nut_mixing,'-','color',color(2,:),'LineWidth',2,...
    'MarkerFaceColor',color(2,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_tke.*Re,nut_tke,'-','color',color(3,:),'LineWidth',2,...
    'MarkerFaceColor',color(3,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon.*Re,nut_kepsilon,'-','color',color(4,:),'LineWidth',2,...
    'MarkerFaceColor',color(4,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon2*Re,nut_kepsilon2,'-','color',color(5,:),'LineWidth',2,...
...
filename2 = strcat(fpath,strcat('all_nutplus2',num2str(Re)));
