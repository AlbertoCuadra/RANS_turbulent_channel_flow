...
ylabel('$k/u_\tau^2$','FontSize',26,'interpreter','latex');
% plot(y_dns,k_dns,'-o','color',color(1,:),'LineWidth',1.4,...
%     'MarkerFaceColor',color(1,:),'MarkerEdgeColor','black',...
%     'MarkerSize',5);
% plot(y_tke,k_tke,'-s','color',color(3,:),'LineWidth',1.4,...
%     'MarkerFaceColor',color(3,:),'MarkerEdgeColor','black',...
%     'MarkerSize',5)
% plot(y_kepsilon,k_kepsilon,'-d','color',color(4,:),'LineWidth',1.4,...
%     'MarkerFaceColor',color(4,:),'MarkerEdgeColor','black',...
%     'MarkerSize',5)
% plot(y_kepsilon2,k_kepsilon2,'-v','color',color(5,:),'LineWidth',1.4,...
%     'MarkerFaceColor',color(5,:),'MarkerEdgeColor','black',...
%     'MarkerSize',5)

plot(y_dns,k_dns,'-','color',color(1,:),'LineWidth',2,...
    'MarkerFaceColor',color(1,:),'MarkerEdgeColor','black',...
    'MarkerSize',5);
plot(y_tke,k_tke,'-','color',color(3,:),'LineWidth',2,...
    'MarkerFaceColor',color(3,:),'MarkerEdgeColor','black',...
    'MarkerSize',5)
plot(y_kepsilon,k_kepsilon,'-','color',color(4,:),'LineWidth',2,...
    'MarkerFaceColor',color(4,:),'MarkerEdgeColor','black',...
    'MarkerSize',5)
plot(y_kepsilon2,k_kepsilon2,'-','color',color(5,:),'LineWidth',2,...
    'MarkerFaceColor',color(5,:),'MarkerEdgeColor','black',...
    'MarkerSize',5)
...
if savefigure
    filename2 = strcat(fpath,strcat('all_k',num2str(Re)));
