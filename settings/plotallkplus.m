...
plot(y_dns*Re,k_dns,'-o','color',color(1,:),'LineWidth',1.4,...
    ...
    'MarkerSize',6);
plot(y_tke*Re,k_tke,'-s','color',color(3,:),'LineWidth',1.4,...
    'MarkerFaceColor',color(3,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon*Re,k_kepsilon,'-d','color',color(4,:),'LineWidth',1.4,...
    'MarkerFaceColor',color(4,:),'MarkerEdgeColor','black',...
    'MarkerSize',6)
plot(y_kepsilon2*Re,k_kepsilon2,'-v','color',color(5,:),'LineWidth',1.4,...
...
filename2 = strcat(fpath,strcat('all_kplus',num2str(Re)));
