The files in this directory (Re550/balances) contain terms in the
...
turbulent channel flow at Re_tau=550. The simulations are reported in:
...
- Data,       Juan C. del \'Alamo and Javier Jim\'enez (2003) "Spectra of the
...
This directory contains 5 files named Re550.bal.<extension>, where
...
There also are 5 files named Re550.std.<extension> containing the 
