% k-epsilon model with damped functions: Lam-Bremhorst
disp('k-epsilon MODEL with Lam-Bremhorst damped functions:');
close all;
tic
model = 34;
sigma_k = 1;
...
while err>eps && it<itmax
    ...
    [u,k,ep,rhs1,rhs2,rhs3,nut] = rk4_kepsilon4(u,k,ep,y,dt);
    % Error
    err1 = norm(rhs1)/n;
    err2 = norm(rhs2)/n;
    err3 = norm(rhs3)/n;
